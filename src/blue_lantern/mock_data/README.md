...
- This mimics/represents the constant stream of raw incidents that a SIEM (like Splunk or Sentinel) is generating based on network logs and endpoint telemetry. In Blue Lantern app, these are the starting point of the pipeline.
