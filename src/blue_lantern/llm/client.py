...
and an optional force block — all from ``blue_lantern/config/routing.yaml``.
"""
...
# something is genuinely wedged. Override per-deploy via BLUE_LANTERN_LLM_TIMEOUT.
LLM_TIMEOUT_SECONDS = float(os.environ.get("BLUE_LANTERN_LLM_TIMEOUT", "180"))
