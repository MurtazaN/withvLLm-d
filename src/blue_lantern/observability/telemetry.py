"""OpenTelemetry tracing bootstrap for Blue Lantern.
...
def setup_tracing(service_name: str = "blue-lantern") -> None:
...
def get_tracer() -> trace.Tracer:
    """Return the blue-lantern tracer (no-op when ``setup_tracing`` wasn't called)."""
    return trace.get_tracer("blue-lantern")
