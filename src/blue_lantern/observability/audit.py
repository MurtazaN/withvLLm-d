"""Structured audit logging helpers for Blue Lantern.
...
``blue_lantern.observability.logging_config`` serializes these as top-level keys, making
...
logger = logging.getLogger("blue-lantern.audit")
